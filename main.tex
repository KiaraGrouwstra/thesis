...
they have no sense of \emph{learning} across problem instances,
meaning they must solve any new synthesis task essentially from scratch.
...
it would be illuminating to go over a slightly more involved example $((\lambda x y z . (+ x y)) 1 2)$,
...
and a ternary function with parameters $x y z$.
...
% in terms of respectable benchmark, L^2 seems to actually have been used by others before.
