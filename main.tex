...
% challenges
% While considered a holy grail of computer science, program synthesis is a challenging task however, characterized by large search spaces, e.g. a space of $10^{5943}$ programs discovering an expert implementation of the MD5 hash function.~\cite{gulwani2017program}
...
% As a result, neural synthesizers will have little intermediary feedback to go by.
...
% % Program specifications in program synthesis may include formal program specifications, natural language descriptions of the program, as well as input-output examples, aka programming by example.
% For our purposes here, we will focus on programming by example (PBE), as having known input-output types will help provide us the needed type information we would like to use.
