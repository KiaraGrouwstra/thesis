...
\begin{displayquote} % \label{hyp:feats}
...
% \begin{displayquote} % \label{hyp:compile}
%     \emph{Research question \#3: can neural program synthesis methods benefit from using compilation checks as additional features?}
% \end{displayquote}
...
% % TODO: figure out if this is really innovation

% \begin{displayquote} % \label{hyp:filter}
%     \emph{Research question \#4: can neural program synthesis methods benefit from type-based filters by reframing the problem to learning-to-rank?}
% \end{displayquote}
...
% \begin{displayquote} % \label{hyp:both}
%     \emph{Research question \#5: can deduction-based neural program synthesis methods benefit from using types and compilation checks as additional features?}
% \end{displayquote}
...
% then, in order to create a training set,
% generating any possible functions using combinations thereof within a given complexity threshold.
...
% \subsubsection{Compiler feedback}

% % \citep{bunel2018leveraging} condition on syntax to generate only correct programs, see their section 5.
% While we would like to also condition on \emph{compiler feedback},
% as per our research hypothesis \ref{hyp:compile}.
...
% As such, this is unfortunately out of scope for our current paper.

% \subsubsection{Type filter}
...
% as per our research hypothesis \ref{hyp:filter}.
