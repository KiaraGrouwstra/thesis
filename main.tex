...
% TODO: handle Emile's comment: "How is the loss defined? This is one of the most important equations in any deep learning paper, I think"
...
% TODO: perform experiment then maybe rewrite following section based on Emile's autoregressive probability distribution view, where any order in which you sample is (mathematically) valid. see https://en.wikipedia.org/wiki/Chain_rule_(probability)
...
% niet elk idee, belangrijke dingen meeste aandacht
...
% \begin{itemize}
    ...
    % % in retrospect, for any problem instances we would already sort of know the available operators, while performance-wise the bottleneck is training, in which case training on a bigger general set of operators is not exactly helping...
