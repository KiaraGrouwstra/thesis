...
This field is named \emph{Programming by Example} (PBE), and was traditionally characterized by methods such as~\citep{gulwani2017program}:
\begin{description}
...
\begin{itemize}
    ...
    \item lay out a way of generating such datasets, including an open-source implementation.
\end{itemize}

\section{Existing work} % \label{sec:existing-work}

% TODO: give overview based on e.g.:
